...
from PyQt5.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, 
                            ...
                            QFormLayout, QInputDialog, QTabWidget, QScrollArea)
...
class SignalDetailsDialog(QDialog):
    ...
    def on_data_type_changed(self, text):
        # Show structure controls when STRUCT type is selected
        is_struct = (text.upper() == "STRUCT")
        self.struct_group.setVisible(is_struct)
        
        # Resize the dialog if needed when showing/hiding structure controls
        if is_struct:
    ...
    def on_init_value_changed(self, index):
